...
$(document).ready(function(){
	...
	var tweetsBase = [
		...
		}, 
		{
			...
			text: 'Over API http://overapi.com/ - интернет ресурс для веб-разработчика. Это шпаргалка-сайт, на котором можно найти ответы на любые вопросы по созданию сайтов и приложений. Сайт содержит примеры кода на любых языках программирования и прочих сервисов и инструментов, и может быть применён для помощи в разработке и вёрстке.', 
		}, 
		{
